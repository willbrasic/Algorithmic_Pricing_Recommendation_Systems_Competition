///////////////////////////////////////////////////////////////////////////
// Sellers Q-learning Varying a_{21} and a_{12} No RS
//
// William Brasic
...
//                pi_plat_store_avg_e[a] = pi_plat_sum/ E;
    ...
    std::ofstream pi_sellers_file, p_sellers_file, d_sellers_file, cs_file, converge_file;

    // Set correct file path prefix
    std::string path_prefix = HPC ? "./" : "../";
    std::string version = "No_RS_Het_a";
    ...
    for (int a{ 0 }; a < a_values; ++a)
    {
        std::vector<std::vector<double>> a_current = a_vector[a];
        for (int i{0}; i < n; ++i) {
            pi_sellers_file << a_current[1][0] << "," << i + 1 << "," << pi_sellers_store_avg_e[i][a] << "\n";
            d_sellers_file << a_current[1][0] << "," << i + 1 << "," << d_sellers_store_avg_e[i][a] << "\n";
            p_sellers_file << a_current[1][0] << "," << i + 1 << "," << p_sellers_store_avg_e[i][a] << "\n";
        }
        cs_file << a_current[1][0] << "," << cs_store_avg_e[a] << "\n";
        converge_file << a_current[1][0] << "," << converge_store_avg_e[a] << "\n";
    }
