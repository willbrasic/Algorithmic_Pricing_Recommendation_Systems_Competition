%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Platform Q-learning and Sellers Q-learning c Results
% William Brasic 
...
% Mean price across sellers for each unique omega and c pair
...
% Mean price across sellers for each unique c 
...
% Total demand across sellers for each unique omega and c pair
...
% Total demand across sellers for each unique c 
...
for w = 1:length(omega)
    ...
    c_values = cs_relative(mask, 2);
    if omega(w) == 4/5
        omega_label = "4/5";
    else
        omega_label = num2str(omega(w));
    end
    h_omega(w) = plot(c_values, cs_relative(mask, 3), "--", "Color", colors(w), ...
        "LineWidth", 2, "DisplayName", strcat("\omega = ", omega_label));
end
h_no_rs = plot(c_values, no_rs_cs_relative(:, 2), "--", "Color", colors(4), ...
        "LineWidth", 2, "DisplayName", "No RS");
hold off;
xlabel("c");
xtickangle(45);
xticks([0, 1/4, 1/2]); 
xticklabels({"0", "1/4", "1/2"});
...
for w = 1:length(omega)
    ...
    c_values = p_sellers_mean_relative(mask, 2);
    if omega(w) == 4/5
        omega_label = "4/5";
    else
        omega_label = num2str(omega(w));
    end
    plot(c_values, p_sellers_mean_relative(mask, 3), "--", "Color", colors(w), ...
        "LineWidth", 2, "DisplayName", strcat("\omega = ", omega_label));
end
plot(c_values, no_rs_p_sellers_mean_relative(:, 2), "--", "Color", colors(4), ...
        "LineWidth", 2, "DisplayName", "No RS");
hold off;
xlabel("c");
xtickangle(45);
...
for w = 1:length(omega)
    ...
    c_values = D_sellers_relative(mask, 2);
    if omega(w) == 4/5
        omega_label = "4/5";
    else
        omega_label = num2str(omega(w));
    end
    plot(c_values, D_sellers_relative(mask, 3), "--", "Color", colors(w), ...
        "LineWidth", 2, "DisplayName", strcat("\omega = ", omega_label));
end
plot(c_values, no_rs_D_sellers_relative(:, 2), "--", "Color", colors(4), ...
        "LineWidth", 2, "DisplayName", "No RS");
hold off;
xlabel("c");
xtickangle(45);
