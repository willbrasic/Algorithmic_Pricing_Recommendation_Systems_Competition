%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Action Space Shifted Upward With RS
% William Brasic 
...
% algorithms engaging in price competition on a platform with RS 
% with two consumer types. The action space is shifted upward relative 
...
for w = 1:length(omega)
    ...
    for e = 1:E
        ...
        while ((t < maxt) && (convergence_count < norm))
            ...
            % Determine subsequent platform state
