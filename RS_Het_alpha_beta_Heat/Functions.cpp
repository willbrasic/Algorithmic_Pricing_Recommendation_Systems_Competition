...
std::vector<double> populate_alpha(
        double alpha_min,
...
)
{
    ...
    // Populate vector with *alpha_values* equally spaced points
...
std::vector<double> populate_beta(
        double beta_min,
...
)
{
    ...
    // Populate vector with *beta_values* equally spaced points
