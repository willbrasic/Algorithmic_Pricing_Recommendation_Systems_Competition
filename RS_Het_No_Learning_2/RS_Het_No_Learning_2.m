...
% preferences. This is the baseline with RS specification. However,
% the RS has no learning component and simply recommends 
% the seller that gives each consumer type the highest utility.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Logit version
logit_version = strrep(version, "_No_Learning_2", "");
...
for s = 1:S_seller_cardinality
    ...
    % Platform action
    if (a(1, 1) - theta(1) * p_sellers(1, s) >= a(2, 1) - theta(1) * p_sellers(2, s)) && (a(1, 2) - theta(2) * p_sellers(1, s) >= a(2, 2) - theta(2) * p_sellers(2, s))
        plat_action = 1;

    elseif (a(1, 1) - theta(1) * p_sellers(1, s) >= a(2, 1) - theta(1) * p_sellers(2, s)) && (a(1, 2) - theta(2) * p_sellers(1, s) < a(2, 2) - theta(2) * p_sellers(2, s))
        plat_action = 2;
...
for w = 1:length(omega)
    ...
    for e = 1:E
        ...
        while ((t < maxt) && (convergence_count < norm))
            ...
            % Platform action
            if (a(1, 1) - theta(1) * p_sellers(1, t) >= a(2, 1) - theta(1) * p_sellers(2, t)) && (a(1, 2) - theta(2) * p_sellers(1, t) >= a(2, 2) - theta(2) * p_sellers(2, t))
                a_plat(t) = 1;

            elseif (a(1, 1) - theta(1) * p_sellers(1, t) >= a(2, 1) - theta(1) * p_sellers(2, t)) && (a(1, 2) - theta(2) * p_sellers(1, t) < a(2, 2) - theta(2) * p_sellers(2, t))
                a_plat(t) = 2;
