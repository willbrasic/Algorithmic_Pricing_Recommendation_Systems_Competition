...
% the preferred seller to each consumer type in each time period.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Logit version
logit_version = strrep(version, "_No_Learning_1", "");
...
plat_actions = 1;                 % Number of platform actions
f = 0.2;                            % Platform fee
